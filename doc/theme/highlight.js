    ...
    return t => {
        const n = (t => {
            const n = t.COMMENT("//", "$", {
                ...
                a = "[a-zA-Z_]\\w*::",
                r = "(decltype\\(auto\\)|" + e(a) + "[a-zA-Z_]\\w*" + e("<[^<>]+>") + ")",
                s = {
                    className: "keyword",
                    begin: "\\b[a-z\\d_]*_t\\b"
                },
                ...
                _ = {
                    ...
                    contains: [{
                        ...
                        keywords: u,
                        relevance: 0,
                        contains: [n, t.C_BLOCK_COMMENT_MODE, i, c, s, {
                            begin: /\(/,
                            end: /\)/,
                            keywords: u,
                            relevance: 0,
...
// ---- DDlog syntax highlighting ---- //
hljs.registerLanguage("ddlog", (() => {
    "use strict";
    ...
    return hljs => {
        ...
        const BUILTIN_TYPES = [
            "Result", "Option", "Either", "Group", "Set",
            "Map", "usize", "isize", "u8", "u16", "u32",
            "u64", "u128", "s8", "s16", "s32", "s64",
            "s128", "bool", "()", "bit", "signed", "Ref",
            "string", "istring", "Vec", "Err", "Ok", "Intern",
        ];
